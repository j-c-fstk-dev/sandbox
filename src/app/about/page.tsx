export default function AboutPage() {
  ...
  transforms the spirit of Earth Day into a <strong>monthly call to action</strong>.
</p>

<p>
  Comprised of environmentalists, community organizers, and everyday change-makers,
  our mission is to <strong>inspire, educate, and empower individuals and communities</strong> to
  take meaningful steps toward sustainability and environmental stewardship,
  on the <strong>22nd of every month</strong>.
</p>
...
<h2 className="text-center" data-oid="4ey8.kr">Why Monthly Action Matters</h2>
            <p data-oid="1n6aj29">
              ...
              monthly rhythm of environmental engagement, we:
            </p>
            <ul data-oid="4pm5ty0">
              <li data-oid="yugadfd">
                <b>Build sustainable habits that become part of our daily lives</b>
              </li>
              <li data-oid="rfxj3xv"><b>Create consistent momentum for environmental progress</b></li>
              <li data-oid=":zidmk.">
                <b>Foster stronger community connections around shared values</b>
              </li>
              <li data-oid="a9x76jc"><b>Provide regular opportunities for education and growth</b></li>
              <li data-oid="rgnozvn"><b>Amplify individual actions into collective impact</b></li>
            </ul>
            ...
            <p data-oid=".4i-pzf">
              ...
              From community clean-ups and tree planting to advocacy campaigns
              and educational workshops, our monthly actions are designed to:
            </p>
            <ul data-oid="nk1frj-">
  ...
  address their specific environmental challenges and opportunities. This
  approach ensures that our actions are both globally coordinated and
  locally relevant.
</p>
<p>
  Through local cleanups, tree-planting initiatives, educational workshops, and
  digital campaigns, <strong>#MonthlyEarthDay</strong> fosters a global
  community united by a shared commitment to a healthier, greener future.
</p>
<p>
  We partner with organizations, schools, and volunteers to create impactful,
  hands-on opportunities that make a difference in our neighborhoods and beyond.
  Join us in redefining environmental activism—because caring for the Earth
  isn’t just an annual event, it’s a way of life.
</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-12 shadow-sm animate-slide-up" data-oid="np.wniz">
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8" data-oid="5dasm-t">
            ...
            <div className="flex-1 prose" data-oid="nzcqq-c">
              ...
              <p data-oid="l_8uz-o">
                When he's not organizing environmental actions, Nick enjoys
                hiking, urban gardening, and exploring sustainable living
                practices.
              </p>
